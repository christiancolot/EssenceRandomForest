...
cdef class TreeBuilder:
    ...
    cpdef build(self, Tree tree, object X, np.ndarray y,
                ...
                np.ndarray variable_weight=None,
...
cdef class DepthFirstTreeBuilder(TreeBuilder):
    ...
    cpdef build(self, Tree tree, object X, np.ndarray y,
        ...
        # do same as in check_input 
        variable_weight = np.asarray(variable_weight, dtype=DOUBLE,order="C")
        cdef DOUBLE_t* variable_weight_ptr = NULL
        variable_weight_ptr = <DOUBLE_t*> variable_weight.data
        ...
        splitter.init(X, y, sample_weight_ptr, variable_weight_ptr, X_idx_sorted)
