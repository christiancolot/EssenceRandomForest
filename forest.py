...
def _parallel_build_trees(tree, forest, X, y, sample_weight, variable_weight, tree_idx, n_trees,
    ...
    if forest.bootstrap:
        ...
        tree.fit(X, y, sample_weight=curr_sample_weight, variable_weight=variable_weight, check_input=False)
    else:
        tree.fit(X, y, sample_weight=sample_weight, variable_weight=variable_weight, check_input=False)
...
class BaseForest(BaseEnsemble, metaclass=ABCMeta):
    ...
    def fit(self, X, y, sample_weight=None, variable_weight=None):
        ...
        if variable_weight is not None:
            variable_weight = check_array(variable_weight, ensure_2d=False)
        if issparse(X):
        ...
        if n_more_estimators < 0:
            ...
            trees = Parallel(n_jobs=self.n_jobs, verbose=self.verbose,
                ...
                delayed(_parallel_build_trees)(
                    t, self, X, y, sample_weight, variable_weight, i, len(trees),
